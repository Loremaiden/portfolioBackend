...
public class LorenabApplication {

    public static void main(String[] args) {
        SpringApplication.run(LorenabApplication.class, args);
    }
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("https://portfoliofrontend-7f0c1.web.app"));
